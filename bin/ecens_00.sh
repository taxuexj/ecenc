...
do
    let ybh=${k}*24
    echo "ybh="$ybh
    echo yb_yyyymmddhh=`${Here_PATH}/bin/newdate ${yyyymmdd}${sc} +${ybh}`
         yb_yyyymmddhh=`${Here_PATH}/bin/newdate ${yyyymmdd}${sc} +${ybh}`
    echo "yb_yyyymmddhh="${yb_yyyymmddhh}
    yb_mmddhh=${yb_yyyymmddhh:4:6}
    echo "yb_mmddhh="${yb_mmddhh}
    ...
    do
        ...
        echo wgrib -s $line|grep ":TP:"|wgrib $line -i -grib -append -o T_${yyyymmdd}${sc}_192_24.GRIB1
             wgrib -s $line|grep ":TP:"|wgrib $line -i -grib -append -o T_${yyyymmdd}${sc}_192_24.GRIB1
        echo wgrib -s $line|grep ":500 mb:"|wgrib $line -i -grib -append -o H_${yyyymmdd}${sc}_192_24.GRIB1
             wgrib -s $line|grep ":500 mb:"|wgrib $line -i -grib -append -o H_${yyyymmdd}${sc}_192_24.GRIB1
        echo wgrib -s $line|grep ":700 mb:"|wgrib $line -i -grib -append -o H_${yyyymmdd}${sc}_192_24.GRIB1
             wgrib -s $line|grep ":700 mb:"|wgrib $line -i -grib -append -o H_${yyyymmdd}${sc}_192_24.GRIB1
        echo wgrib -s $line|grep ":850 mb:"|wgrib $line -i -grib -append -o H_${yyyymmdd}${sc}_192_24.GRIB1
             wgrib -s $line|grep ":850 mb:"|wgrib $line -i -grib -append -o H_${yyyymmdd}${sc}_192_24.GRIB1
    done
done
################################################################################################
echo grib_to_netcdf -o T_${yyyymmdd}${sc}_192_24.NC T_${yyyymmdd}${sc}_192_24.GRIB1
     grib_to_netcdf -o T_${yyyymmdd}${sc}_192_24.NC T_${yyyymmdd}${sc}_192_24.GRIB1
echo grib_to_netcdf -o H_${yyyymmdd}${sc}_192_24.NC H_${yyyymmdd}${sc}_192_24.GRIB1
     grib_to_netcdf -o H_${yyyymmdd}${sc}_192_24.NC H_${yyyymmdd}${sc}_192_24.GRIB1
################################################################################################
echo ncdump -h T_${yyyymmdd}${sc}_192_24.NC 
     ncdump -h T_${yyyymmdd}${sc}_192_24.NC > T_${yyyymmdd}${sc}_192_24.CDL
echo ncdump -h H_${yyyymmdd}${sc}_192_24.NC 
     ncdump -h H_${yyyymmdd}${sc}_192_24.NC > H_${yyyymmdd}${sc}_192_24.CDL
################################################################################################
...
################################################################################################
echo grib2ctl.pl -verf T_${yyyymmdd}${sc}_192_24.GRIB1 
     grib2ctl.pl -verf T_${yyyymmdd}${sc}_192_24.GRIB1 > T_${yyyymmdd}${sc}_192_24.ctl
echo grib2ctl.pl -verf H_${yyyymmdd}${sc}_192_24.GRIB1
     grib2ctl.pl -verf H_${yyyymmdd}${sc}_192_24.GRIB1 > H_${yyyymmdd}${sc}_192_24.ctl
echo gribmap -i T_${yyyymmdd}${sc}_192_24.ctl
     gribmap -i T_${yyyymmdd}${sc}_192_24.ctl
echo gribmap -i H_${yyyymmdd}${sc}_192_24.ctl
     gribmap -i H_${yyyymmdd}${sc}_192_24.ctl
################################################################################################
cat > T_${yyyymmdd}${sc}_192_24.gs << EOF
'reinit'
'open T_${yyyymmdd}${sc}_192_24.ctl'
j=1
while(j<8)
'c'
...
'quit'
EOF
grads -pbc "T_${yyyymmdd}${sc}_192_24.gs"
################################################################################################
...
do
    ...
    do
        ...
        echo wgrib -s $line|grep ":type=Perturbed"|grep ":TP:"|wgrib $line -i -grib -append -o P_${yyyymmdd}${sc}_192_24.GRIB1
             wgrib -s $line|grep ":type=Perturbed"|grep ":TP:"|wgrib $line -i -grib -append -o P_${yyyymmdd}${sc}_192_24.GRIB1
#        # echo wgrib -s ${fname}.GRIB|wgrib ${fname}.GRIB -i -grib -o ${fname}.GRIB1
        ...
        echo wgrib2 -match "pert=0" -match ":KX:" $line -append -grib_out K_${yyyymmdd}${sc}_192_24.GRIB2             
             wgrib2 -match "pert=0" -match ":KX:" $line -append -grib_out K_${yyyymmdd}${sc}_192_24.GRIB2
        echo wgrib -s $line|grep "forecast 0:"|grep ":TP:"|wgrib $line -i -grib -append -o C_${yyyymmdd}${sc}_192_24.GRIB1
             wgrib -s $line|grep "forecast 0:"|grep ":TP:"|wgrib $line -i -grib -append -o C_${yyyymmdd}${sc}_192_24.GRIB1
        for num in {1..50}
        do
            echo wgrib -s $line|grep "forecast ${num}:"|grep ":TP:"|wgrib $line -i -grib -append -o P${num}_${yyyymmdd}${sc}_192_24.GRIB1
                 wgrib -s $line|grep "forecast ${num}:"|grep ":TP:"|wgrib $line -i -grib -append -o P${num}_${yyyymmdd}${sc}_192_24.GRIB1
#                grib_to_netcdf -o P${num}_${yyyymmdd}${sc}_192_24.NC P${num}_${yyyymmdd}${sc}_192_24.GRIB1
        done 
    done
done
echo wgrib2 K_${yyyymmdd}${sc}_192_24.GRIB2 -netcdf K_${yyyymmdd}${sc}_192_24.NC
     wgrib2 K_${yyyymmdd}${sc}_192_24.GRIB2 -netcdf K_${yyyymmdd}${sc}_192_24.NC
echo ncdump -h K_${yyyymmdd}${sc}_192_24.NC
     ncdump -h K_${yyyymmdd}${sc}_192_24.NC > K_${yyyymmdd}${sc}_192_24.CDL
echo grib_to_netcdf -o C_${yyyymmdd}${sc}_192_24.NC C_${yyyymmdd}${sc}_192_24.GRIB1
     grib_to_netcdf -o C_${yyyymmdd}${sc}_192_24.NC C_${yyyymmdd}${sc}_192_24.GRIB1
...
echo grib_to_netcdf -o P_${yyyymmdd}${sc}_192_24.NC P_${yyyymmdd}${sc}_192_24.GRIB1
     grib_to_netcdf -o P_${yyyymmdd}${sc}_192_24.NC P_${yyyymmdd}${sc}_192_24.GRIB1
...
################################################################################################
echo grib2ctl.pl -verf C_${yyyymmdd}${sc}_192_24.GRIB1
     grib2ctl.pl -verf C_${yyyymmdd}${sc}_192_24.GRIB1 > C_${yyyymmdd}${sc}_192_24.ctl
echo gribmap -i C_${yyyymmdd}${sc}_192_24.ctl
     gribmap -i C_${yyyymmdd}${sc}_192_24.ctl
cat > C_${yyyymmdd}${sc}_192_24.gs << EOF
'reinit'
'open C_${yyyymmdd}${sc}_192_24.ctl'
j=1
while(j<8)
'c'
'set display color white'
...
'quit'
EOF
grads -pbc "C_${yyyymmdd}${sc}_192_24.gs"
################################################################################################
for num in {1..50}
do
    grib2ctl.pl -verf P${num}_${yyyymmdd}${sc}_192_24.GRIB1 > P${num}_${yyyymmdd}${sc}_192_24.GRIB1.ctl
    gribmap -i P${num}_${yyyymmdd}${sc}_192_24.GRIB1.ctl
    cat > P${num}_${yyyymmdd}${sc}_192_24.GRIB1.gs << EOF
'reinit'
'open P${num}_${yyyymmdd}${sc}_192_24.GRIB1.ctl'
j=1
while(j<8)
'c'
'set display color white'
...
'quit'
EOF
   grads -pbc "P${num}_${yyyymmdd}${sc}_192_24.GRIB1.gs"
done
################################################################################################
