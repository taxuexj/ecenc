...
#        # echo wgrib -s ${fname}.GRIB|wgrib ${fname}.GRIB -i -grib -o ${fname}.GRIB1
        ...
        echo wgrib2 -s $line|grep "pert=0"|wgrib2 $line -append -grib_out K_${yyyymmdd}${sc}_192_24.GRIB2
             wgrib2 -s $line|grep "pert=0"|wgrib2 $line -append -grib_out K_${yyyymmdd}${sc}_192_24.GRIB2
...
echo grib_to_netcdf -R 20151026 -o aaaa.nc T_2015102612_192_24.GRIB1
